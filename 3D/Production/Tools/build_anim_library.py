...
GOALIE_LIB = [
    ...
    Clip("goalie_crossover_left", 724, 20, True, shuffle(+1, 20), notes="crossover rhythm toward shooter-left (in place)"),
    Clip("goalie_crossover_right", 754, 20, True, shuffle(-1, 20), notes="mirror"),
